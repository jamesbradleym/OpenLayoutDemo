...
{
	/// <summary>
	/// Override metadata for OpenSpaceSettingsOverride
	/// </summary>
	public partial class OpenSpaceSettingsOverride : IOverride
	{
        public static string Name = "Open Space Settings";
        public static string Dependency = "Space Planning Zones";
        public static string Context = "[*discriminator=Elements.SpaceBoundary&Name=Retail]";
	...
	public static class OpenSpaceSettingsOverrideExtensions
    {
		/// <summary>
        /// Apply Open Space Settings edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Open Space Settings Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<OpenSpaceSettingsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, OpenSpaceSettingsIdentity, bool> identityMatch,
            Func<T, OpenSpaceSettingsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Open Space Settings Overrides to apply — typically `input.Overrides.OpenSpaceSettings`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<OpenSpaceSettingsOverride> overrideData,
            Func<T, OpenSpaceSettingsIdentity, bool> identityMatch,
            Func<T, OpenSpaceSettingsOverride, T> modifyElement
            ) where T : Element
        {
