...
namespace OpenLayoutDemo
{
    public class Function
    {
        ...
        private IModelStore<OpenLayoutDemoInputs> store;

        public async Task<OpenLayoutDemoOutputs> Handler(OpenLayoutDemoInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<OpenLayoutDemoInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<OpenLayoutDemoInputs,OpenLayoutDemoOutputs>(store, OpenLayoutDemo.Execute);
